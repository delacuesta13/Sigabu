...
=======
seccional [Cali](http://ucc.edu.co/cali/Paginas/UniversidadCooperativadeColombia_Cali.aspx), es un proyecto de desarrollo de software llevado a cabo
>>>>>>> 2bba1594d10631c6fbc6c744f9f5224f107fe07d
...
=======
deportivo y/o cultural donde se desarrollará éste). Después de programadas las actividades, se permite la gestión de las inscripciones[^nota1] de las
personas[^nota2] beneficiarias de Bienestar U en éstas. Por último, y después de la gestión de inscripciones, 
el Sistema permite el control de asistencia de las actividades programadas. 

[^nota1]: Es pre-requisito de inscripción que la persona tenga un perfil en el periodo de la programación de la actividad. Un perfil es la clasificación
de la persona dentro de la comunidad universitaria (ver [^nota2]).
[^nota2]: Las personas beneficiarias de Bienestar U, son quienes componen la denominada *comunidad universitaria*. Esta comunidad clasifica las personas
en: estudiantes, docentes (catedrático, medio tiempo o tiempo completo), funcionarios, egresados y familiares (del primer grando de consanguineidad o
afinidad de los anteriores).
>>>>>>> 2bba1594d10631c6fbc6c744f9f5224f107fe07d
