	...
	if($rs_crear) {
		...
		<div class="flash">
			<div class="message notice">
				<p>El período se ha creado exitósamente.</p>
			</div>
		</div>
		<?php 		
	} else {
		...
		<div class="flash">
			<div class="message error">
				<p>Bueno, esto es vergonzoso. Se ha intentado guardar el periodo, pero al parecer existe un error.</p>
			</div>
		</div>
		<?php 
	}
	...
	<div class="columns wat-cf">
		<div class="column left">
			...
			<div class="group">
				...
				<?php if(isset($_POST['periodo']) && (isset($ind_error) || (isset($rs_crear) && !$rs_crear))) echo 'value="' . $_POST['periodo'] . '"';?>
				/>
			...
			<div class="group">
				...
				<?php if(isset($_POST['actual']) && (isset($ind_error) || (isset($rs_crear) && !$rs_crear))) echo 'checked="checked"'?>
