	...
	if($rs_crear) {
		...
		<div class="flash">
			<div class="message notice">
				<p>La persona se ha creado exitósamente.</p>
			</div>
		</div>
		<?php 		
	} else {
		...
		<div class="flash">
			<div class="message error">
				<p>Bueno, esto es vergonzoso. Se ha intentado guardar la persona, pero al parecer existe un error.</p>
			</div>
		</div>
		<?php 
	}
...
<form method="post" name="formulario" id="formulario" action="<?php echo BASE_PATH . '/' . strtolower($this->_controller) . '/' . $this->_action;?>" class="form">
	...
	<div class="group">
		...
		<?php if(isset($_POST['nombres']) && (isset($ind_error) || (isset($rs_crear) && !$rs_crear))) echo 'value="' . $_POST['nombres'] . '"';?>
		/>
	...
	<div class="group">
		...
		<?php if(isset($_POST['apellidos']) && (isset($ind_error) || (isset($rs_crear) && !$rs_crear))) echo 'value="' . $_POST['apellidos'] . '"';?>
		/>
	...
	<div class="group">
		...
		<select name="tipo_dni" id="tipo_dni">
			...
			<option value="CC" <?php if(isset($_POST['tipo_dni']) && (isset($ind_error) || (isset($rs_crear) && !$rs_crear)) && $_POST['tipo_dni']=="CC") echo 'selected="selected"';?>>Cédula de Cuidadanía</option>
			<option value="CE" <?php if(isset($_POST['tipo_dni']) && (isset($ind_error) || (isset($rs_crear) && !$rs_crear)) && $_POST['tipo_dni']=="CE") echo 'selected="selected"';?>>Cédula de Extranjería</option>
			<option value="TI" <?php if(isset($_POST['tipo_dni']) && (isset($ind_error) || (isset($rs_crear) && !$rs_crear)) && $_POST['tipo_dni']=="TI") echo 'selected="selected"';?>>Tarjeta de Identidad</option>
			<option value="RC" <?php if(isset($_POST['tipo_dni']) && (isset($ind_error) || (isset($rs_crear) && !$rs_crear)) && $_POST['tipo_dni']=="RC") echo 'selected="selected"';?>>Registro Civil</option>
		</select>
	</div>
	...
	<div class="group">
		...
		<?php if(isset($_POST['dni']) && (isset($ind_error) || (isset($rs_crear) && !$rs_crear))) echo 'value="' . $_POST['dni'] . '"';?>
		/>
	...
	<div class="group">
		...
		<?php if(isset($_POST['fecha_nac']) && (isset($ind_error) || (isset($rs_crear) && !$rs_crear))) echo 'value="' . $_POST['fecha_nac'] . '"';?>
		/>
	...
	<div class="group">
		...
		<select name="genero" id="genero">
			...
			<option value="H" <?php if(isset($_POST['genero']) && (isset($ind_error) || (isset($rs_crear) && !$rs_crear)) && $_POST['genero']=="H") echo 'selected="selected"';?>>Hombre</option>
			<option value="M" <?php if(isset($_POST['genero']) && (isset($ind_error) || (isset($rs_crear) && !$rs_crear)) && $_POST['genero']=="M") echo 'selected="selected"';?>>Mujer</option>
		</select>
	</div>
	...
	<div class="group">
		...
		<?php if(isset($_POST['direccion_residencia']) && (isset($ind_error) || (isset($rs_crear) && !$rs_crear))) echo 'value="' . $_POST['direccion_residencia'] . '"';?>
		/>
	...
	<div class="group">
		...
		<?php if(isset($_POST['monitor']) && (isset($ind_error) || (isset($rs_crear) && !$rs_crear))) echo 'checked="checked"'?>
	...
	<div class="group">
		...
		<?php 
		if(isset($_POST['estado']) && (isset($ind_error) || (isset($rs_crear) && !$rs_crear))) echo 'checked="checked"';
		elseif(!isset($_POST['estado']) && (!isset($ind_error) && !isset($rs_crear))) echo 'checked="checked"';
		?>
